...
#ifndef APP_COMMANDS_COMMANDS_LIST_H_INCLUDED
#define APP_COMMANDS_COMMANDS_LIST_H_INCLUDED
#pragma once
...
FOR_EACH_COMMAND(DuplicateAspect)
...
FOR_EACH_COMMAND(EnterLicense)
FOR_EACH_COMMAND(Exit)
FOR_EACH_COMMAND(ExportCel)
FOR_EACH_COMMAND(ExportSpriteSheet)
FOR_EACH_COMMAND(Eyedropper)
FOR_EACH_COMMAND(FillAndStroke)
...
FOR_EACH_COMMAND(LayerClippingMask)
...
FOR_EACH_COMMAND(PixelBounds)
FOR_EACH_COMMAND(PlayAnimation)
FOR_EACH_COMMAND(PlayOnce)
...
FOR_EACH_COMMAND(SetColorSameAsBg)
FOR_EACH_COMMAND(SetLoopSection)
FOR_EACH_COMMAND(SetPalette)
FOR_EACH_COMMAND(SetPaletteEntrySize)
FOR_EACH_COMMAND(SetSameColor)
FOR_EACH_COMMAND(ShowAutoCelGuides)
...
FOR_EACH_COMMAND(TilesetDeleteUnused)
FOR_EACH_COMMAND(ToggleWorkspaceLayout)
FOR_EACH_COMMAND(Undo)
FOR_EACH_COMMAND(UnlinkCel)
FOR_EACH_COMMAND(UnpackPsdGroup)
FOR_EACH_COMMAND(UseImgAsPattern)
FOR_EACH_COMMAND(UseMask)
